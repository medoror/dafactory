...
You are building `{{app}}`. Read SPEC.md, every file in adr/, BACKLOG.md, and
PROGRESS.md at the start of every session.

## Workflow
- Clarify the design, write a short plan, implement test-first in small steps, review
  against the plan. Prefer red/green/refactor.
